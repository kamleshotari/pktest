...
class ParkingLotsControllerTest < ActionController::TestCase
  ...
  test "should create parking_lot" do
    assert_difference('ParkingLot.count') do
      post :create, parking_lot: { distance: @parking_lot.distance, floor_level: @parking_lot.floor_level, is_allocated: @parking_lot.is_allocated, slot_no: @parking_lot.slot_no }
    end
  ...
  test "should update parking_lot" do
    patch :update, id: @parking_lot, parking_lot: { distance: @parking_lot.distance, floor_level: @parking_lot.floor_level, is_allocated: @parking_lot.is_allocated, slot_no: @parking_lot.slot_no }
    assert_redirected_to parking_lot_path(assigns(:parking_lot))
  end
